...
**RBO** es una aplicación web moderna desarrollada con **Flask** y **MariaDB**, enfocada en la gestión de usuarios y difusión de noticias. Utiliza una interfaz minimalista con estética *Glassmorphism* mediante **Tailwind CSS**.
